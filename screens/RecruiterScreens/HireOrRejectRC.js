...
export default function HireOrRejectRC({ route }) {
    ...
    const HireCandidate = async () => {
        ...
        Alert.alert("Candidate Hired", "An Message has been forwarded to candidate regarding the hiring", [
            {
                text: "OK",
                style: "default"
            },
    ...
    const RejectCandidate = async () => {
        ...
        Alert.alert("Candidate Rejected", "Youe response will be forwarded to candidate", [
            {
                text: "OK",
                style: "default"
            },
        ...
        >
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{marginVertical: 30, flexDirection: "row", justifyContent: "space-between"}}>
                    <TouchableOpacity style={{width: "45%", backgroundColor: theme.primaryColor, paddingVertical: 20, borderRadius: 10}} onPress={RejectCandidate}>
                        <Text style={{textAlign: "center", color: "white", fontSize: 16}}>Reject</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{width: "45%", backgroundColor: theme.greenColor, paddingVertical: 20, borderRadius: 10}} onPress={HireCandidate}>
                        <Text style={{textAlign: "center", color: "white", fontSize: 16, fontWeight: "700"}}>Hire</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
